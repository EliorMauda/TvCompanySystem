...
void initCommercial(Commercial* pCom, const Commercial* commercialArr, int commercialNum);
void commercialLength(Commercial* pCom);
int getCommercialType(Commercial* pCom);
int	isCommercialNameUnique(const Commercial* commercialArr, int commercialNum, char* name);
